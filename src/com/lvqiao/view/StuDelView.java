...
public class StuDelView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StuDelView frame = new StuDelView();
	...
	public StuDelView() {
			...
			public void mouseClicked(MouseEvent e) {
				if (e.getClickCount() == 2) {
					...
					if(n==0){
						...
						conn.delstu(tname);
						JOptionPane.showMessageDialog(StuDelView.this, "删除成功！！");
						fillTable(null);
					}
					} 
			}
		...
		bg.setIcon(new ImageIcon(StuDelView.class.getResource("/images/class.png")));
