...
public class ReaderDelView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReaderDelView frame = new ReaderDelView();
	...
	public ReaderDelView() {
				...
				if (e.getClickCount() == 2) {
					...
					if(n==0){
						...
						StudentTypeDao conn = new StudentTypeDao();
						 conn.delrea(tname);
						JOptionPane.showMessageDialog(ReaderDelView.this, "删除成功！！");
						fillTable(null);
					}
					} 
			}
		...
		bg.setIcon(new ImageIcon(ReaderDelView.class.getResource("/images/reader.png")));
